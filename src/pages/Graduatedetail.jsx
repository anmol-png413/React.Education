...
//                   private higher education institutions across Malaysia. The agency serves as the
//                   national authority for quality assurance in higher education.
//                 </p>
...
//                     To be a global authority in quality assurance of higher education
//                   </p>
//                 </div>
...
//                   </div>
//                   <p className="text-slate-600 leading-relaxed">
//                     To put in place a system of quality assurance for higher education recognised internationally
//                     and aligned with national development needs
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//                     <role.icon className="w-7 h-7 text-emerald-700" />
//                   </div>
//                   <h4 className="font-bold text-slate-900 mb-3 leading-snug">{role.title}</h4>
...
//                   >
//                     <audience.icon className="w-8 h-8 text-white" strokeWidth={2} />
//                   </div>
...
//   const Process = () => {
  ...
  return (
    <>
      ...
      <section
        id="home"
        className="relative bg-gradient-to-br from-slate-50 via-emerald-50/30 to-teal-50/40 overflow-hidden"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 relative">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full border border-emerald-200 mb-5 shadow-sm">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-10">
              <a
                href="#about"
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200"
              >
                Learn More
              </a>
              <a
                href="#check"
                className="inline-flex items-center px-8 py-4 bg-white text-emerald-700 font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 border-2 border-emerald-200"
              >
...
{/* 
          ...
          {Anmol.map((step, index) => (
            <div key={index} className="relative group">
              <div className="bg-white rounded-2xl p-6 border-2 border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 h-full">
                <div className="absolute -top-4 left-6 bg-gradient-to-br from-emerald-600 to-teal-600 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm shadow-lg">
                  {index + 1}
                </div>

                <div className="bg-gradient-to-br from-emerald-100 to-teal-100 w-16 h-16 rounded-xl flex items-center justify-center mb-4 mt-2 group-hover:scale-110 transition-transform duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-br from-emerald-600 to-teal-600 rounded-2xl p-8 sm:p-12 text-white shadow-2xl text-center">
          ...
          <a
            ...
            className="inline-flex items-center space-x-2 bg-white text-emerald-700 px-8 py-4 rounded-xl font-bold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200"
          >
