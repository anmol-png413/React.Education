...
useEffect(() => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen px-4 sm:px-1 lg:px-2 ">
          ...
          <div className="grid gap-5">
            ...
            <div className="flex gap-3 text-center">
              ...
              <InputWithIcon
                ...
                name="source"
                placeholder=""
                value={formData.source="Education Malaysia - University Profile "}
                onChange={handleChange}
              />
               <InputWithIcon
                type="hidden"
            ...
            <div className="relative">
              ...
              >
                ...
                {Array.isArray(program) && program.map((p) => (
