...
//   return (
//     <section className="bg-gradient-to-b from-white to-blue-50 px-4 pt-12 pb-20 md:px-10 lg:px-20">
//       {/* Heading */}
...
//               <div className="group bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border border-slate-200 h-[450px] flex flex-col justify-between">
//                 {/* Top Section */}
