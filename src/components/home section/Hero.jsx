...
//   // ✅ Loading skeleton - Better UI
//   if (loading) {
//     return (
//       <section className="relative w-full h-screen overflow-hidden bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 flex items-center justify-center">
...
//   // ✅ Default fallback data agar banners nahi mile
//   const defaultBanner = {
...
//   // ✅ Agar banners empty hai to default use karo
//   const displayBanners = banners.length > 0 ? banners : [defaultBanner];

//   // ✅ First banner ka data use karenge for text content
//   const mainBanner = displayBanners[0];

//   return (
//     <section className="relative w-full h-screen overflow-hidden">
//       {/* ✅ Swiper Background Slider - Banner Images */}
//       <div className="absolute inset-0 z-0">
//         <Swiper
...
//               <img
//                 src={`https://www.educationmalaysia.in/storage/${banner.banner_path}`}
//                 alt={banner.alt_text || `Banner ${i + 1}`}
//                 className="w-full h-full object-cover"
//                 onError={(e) => {
//                   e.target.src = '/fallback-banner.jpg'; // Fallback image
//                 }}
//               />
//             </SwiperSlide>
//           ))}
...
//       {/* ✅ Content - Banner data se populate */}
//       <div className="relative z-20 flex items-center h-full px-6 md:px-20 pointer-events-none">
//         <motion.div
//           className="text-white max-w-3xl"
//           variants={containerVariants}
