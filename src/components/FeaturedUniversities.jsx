...
// // //     // 🎯 UNIVERSITY PAGE - Direct featured universities endpoint
...
// // //       } catch (error) {
// // //         console.error("❌ Featured universities fetch error:", error);
...
// // //   return (
// // //     <div className="bg-white shadow-md rounded-xl p-3 mt-8">
// // //       <h2 className="text-lg font-semibold text-gray-900 mb-4 pb-3 border-b">
// // //         Featured Universities
// // //       </h2>
...
// // //             >
// // //               <div className="flex items-start gap-3 p-3 hover:bg-gray-50 transition-all duration-200 rounded-lg border border-gray-100 hover:border-blue-200 hover:shadow-md">
                
// // //                 {/* University Logo */}
// // //                 <div className="w-14 h-14 flex-shrink-0 rounded-lg border border-gray-200 bg-white flex items-center justify-center overflow-hidden p-1">
// // //                   {img ? (
// // //                     <img
// // //                       src={img}
// // //                       alt={uni.name}
...
// // //                   <h3 className="font-bold text-blue-900 text-sm mb-1.5 line-clamp-2 group-hover:text-blue-700 transition-colors leading-tight">
// // //                     {uni.name}
// // //                   </h3>
...
// //                 {/* Programme Button - CLICKABLE - COURSES PAGE */}
// //                 <Link 
...
//                 {/* ✅ Programme Button - NO SCROLL TO TOP */}
//                 <Link 
//                   to={`/university/${uni.uname}/courses`}
                ...
                <Link 
                  ...
                  onClick={() => {
                    setTimeout(() => {
                      ...
                      if (coursesSection) {
                        // Found the courses section - scroll to it
                        coursesSection.scrollIntoView({ 
                          behavior: 'smooth', 
                          block: 'start' // Section ko top pe laye (thoda space ke saath)
                        });
                      } else {
                        // Agar courses section nahi mila, to filters/main content pe scroll karo
                        ...
                        if (filterSection) {
                          ...
                          // Last resort - fixed pixel scroll
                          window.scrollTo({
                            top: 400,
                            behavior: 'smooth'
                          });
